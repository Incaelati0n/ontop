...
/**
 * Creates QuotedIdentifiers following the rules of FlinkSQL:
 *    - double and single quotes are not tolerated for schema and attributes definition
 */

public class FlinkSQLQuotedIDFactory extends SQLStandardQuotedIDFactory {
    ...
    protected QuotedID createFromString(@Nonnull String s) {
        ...
        // Backticks are tolerated for FlinkSQL schema and table names, but not necessary
