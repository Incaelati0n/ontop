...
/**
 *  Kafka-SQL functions description available at : https://ci.apache.org/projects/Kafka/Kafka-docs-stable/
 */
public class KafkaSQLDBFunctionSymbolFactory extends AbstractSQLDBFunctionSymbolFactory {

    private static final String UNSUPPORTED_MSG = "Not supported by Kafka or not still to be implemented";

    @Inject
    protected KafkaSQLDBFunctionSymbolFactory(TypeFactory typeFactory) {
        super(createKafkaSQLRegularFunctionTable(typeFactory), typeFactory);
    }

    protected static ImmutableTable<String, Integer, DBFunctionSymbol> createKafkaSQLRegularFunctionTable(
