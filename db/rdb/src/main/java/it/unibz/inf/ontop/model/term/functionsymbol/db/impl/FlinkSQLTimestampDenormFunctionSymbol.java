...
public class FlinkSQLTimestampDenormFunctionSymbol extends AbstractDBTypeConversionFunctionSymbolImpl{

    private final DBTermType dbStringType;
    protected static final String TEMPLATE = "TO_TIMESTAMP(%s, 'yyyy-MM-dd HH:mm:ss.SSS')";

    protected FlinkSQLTimestampDenormFunctionSymbol(DBTermType dbTimestampType,DBTermType dbStringType) {
